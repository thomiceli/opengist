...
```shell
docker pull ghcr.io/thomiceli/opengist:1.15.2
```
...
wget https://github.com/thomiceli/opengist/releases/download/v1.15.2/opengist1.15.2-linux-amd64.tar.gz

tar xzvf opengist1.15.2-linux-amd64.tar.gz
cd opengist
chmod +x opengist
